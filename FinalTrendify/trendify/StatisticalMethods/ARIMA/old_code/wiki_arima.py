...
def find_best_rmse_ARIMA_model(words, start, end):
    RMSE, anomaly_points = [], []
    ...
    fpath = os.path.join(OUTPUT_DIR, f'wiki_data_arima_{start}_{end}.csv')
...
# end = 10295
# t1 = time.time()
# find_best_rmse_ARIMA_model(words, start, end)
# t2 = time.time()
...
target_method_call = find_best_rmse_ARIMA_model
