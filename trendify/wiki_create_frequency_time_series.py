...
def load_wikipedia_stats_dataset(pageviews_directory, output_csv_path, hours_per_file):
    ...
    #for filename in ["pageviews-20170101-000000.gz", "pageviews-20170101-010000.gz"]: #, "pageviews-20170101-020000.gz", "pageviews-20170101-030000.gz", "pageviews-20170101-040000.gz"]:
        if filename[:2] == "pa":
            ...
            print (file_count, number_of_files)
    ...
    print ("Done creating the wiki files")
                            ...
                            for line in csv_reader:
                                if len(line) > 1:
                                    ...
                                    if frequencies.count(0) <= zero_tolerance*len(frequencies):
                                        ...
                                        if trendy:
                                            frequencies_string = ",".join([str(x) for x in frequencies])
...
output_csv_path = '/data21/asaleh/share/trendify_data/frequency_timeseries_data/wiki_stats/'
hours_per_file = 64
zero_tolerance = 0.2
train_split = 0.8  # test_split / valid_split = (1-train_split)/2
data_file = 'trendy'  # or not_trendy

print ("Load and process wiki pageview files...")
...
preprocess(output_csv_path, zero_tolerance=zero_tolerance)

print ("Start train tets valid generation...")
